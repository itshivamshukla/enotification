...
export class NoticeboardController {
    ...
    public insertNoticeboard(req: Request, res: Response, next: NextFunction) {

        Logger.info('insertNoticeboards :: Noticeboards');

        let noticeboardsDAO = new NoticeboardDAO();
        noticeboardsDAO.insertNoticeboard(req, res, next);
    }
