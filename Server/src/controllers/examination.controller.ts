...
export class ExaminationController {
    ...
    public insertExamination(req: Request, res: Response, next: NextFunction) {

        Logger.info('insertExaminations :: Examinations');

        let examinationsDAO = new ExaminationDAO();
        examinationsDAO.insertExamination(req, res, next);
    }
